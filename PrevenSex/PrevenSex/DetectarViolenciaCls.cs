...
namespace PrevenSex
{
    [Activity(Label = "Cómo detectar la violencia de género", Theme = "@style/AppTheme.NoActionBar")]
    public class DetectarViolenciaCls : AppCompatActivity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.detectarViolencia_main);
