...
namespace PrevenSex
{
    [Activity(Label = "Contactanos", Theme = "@style/AppTheme.NoActionBar")]
    public class ContactanosCls : AppCompatActivity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.contactanos_main);
